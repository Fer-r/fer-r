...
*Building practical, functional apps for web and Android*
...
I'm a developer with **dual training in Web and Multiplatform Application Development**, passionate about building clean and practical software. My background spans both mobile and web development — from native Android apps to modern React frontends and PHP/Symfony backends.

- 🏗️ Recently worked on **frontend components in React** and **backend API endpoints with PHP/Symfony**
- 📱 Built **native Android applications** using Kotlin
- 🔧 Briefly worked with **Salesforce** to improve code maintainability
